# E-Commerce Customer & Order Analytics (SQL)
...
2. Open it using any SQLite-compatible tool (DB Browser for SQLite, SQLiteStudio, or Python)
3. Run analytical queries to explore KPIs and insights
